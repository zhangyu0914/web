	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			if (!StringUtils.isBlank(dbIp)) {//docker 环境
				...
				fileContent.append("url=jdbc:mysql://"+dbIp+":3306/webplatform?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true" + "\n");
