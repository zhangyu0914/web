...
public class Hxls2List implements HSSFListener {
	...
	public Hxls2List(InputStream is,Map<Integer, ExcelColumn> excelHeadMap,Map<String, Map> columnsConvertMap,Class cls,ArrayList<Object> contents) throws FileNotFoundException, IOException{
