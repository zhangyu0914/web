...
public class DeviceModelAttServiceTest extends BaseControllerTest {
	...
	public void insert(){
		try {
			DeviceModelAttEntity entity = new DeviceModelAttEntity();
			
			entity.setTid(UUIDUtil.getUUID());
			
			entity.setFkModelAttTid(String.valueOf(1));
			entity.setAttValue(String.valueOf(1));


			Integer resultUtil = this.deviceModelAttService.insert(entity);
	...
	public void update(){
		try {
			...
			ResultUtil<List<DeviceModelAttDto>> list = this.deviceModelAttService.
					findPage(null, new InterfacePage<DeviceModelAttEntity>());
			...
			entity.setAttValue(String.valueOf(1));
				...
				Integer resultUtil = this.deviceModelAttService.update(entity);
	...
	public void findPage() {
		try {
			...
			DeviceModelAttEntity entity = new DeviceModelAttEntity();
			InterfacePage<DeviceModelAttEntity> ihygeiaPage = new InterfacePage<DeviceModelAttEntity>();
			
			ResultUtil<List<DeviceModelAttDto>> resultUtil= this.deviceModelAttService.findPage(entity, ihygeiaPage);
	...
	public void findOne() {
		try {
			...
			DeviceModelAttEntity entity = new DeviceModelAttEntity();
			DeviceModelAttEntity resultUtil= this.deviceModelAttService.findOne(entity);
